...
function custom_staff_plugin_activate()
{
    ...
    require_once(LWS_STAFF_DIR . 'includes/staff-page-template/staff-theme-page.php');
}
...
require_once(LWS_STAFF_DIR . 'includes/staff-meta-functions.php');

// Staff ACF block
require_once(LWS_STAFF_DIR . 'acf-blocks/staff-block-main.php');
